...
@Slf4j
public class DeliveryNoteProductEditAction extends CommonEditAction {
    @Override
    protected void before(Arg arg) {
        // 发货单产品不可编辑
        throw new DeliveryNoteBusinessException(DeliveryNoteErrorCode.DELIVERY_NOTE_PRODUCT_UNABLE_TO_EDIT);
    }
}
