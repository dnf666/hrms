package com.facishare.crm.erpstock.base;
...
public class BaseActionTest extends BaseTest {
    ...
    public String getObjectDescribeId() throws MetadataServiceException {
        IObjectDescribe desc = objectDescribeService.findByTenantIdAndDescribeApiName(tenantId, apiName);
        return desc.getId();

    }

    public IObjectDescribe getObjectDescribe() throws MetadataServiceException {

        IObjectDescribe desc = objectDescribeService.findByTenantIdAndDescribeApiName(tenantId, apiName);
        return desc;
    }

    public <T> Object executeAdd(IObjectData objectData, Map<String, List<ObjectDataDocument>> details) throws MetadataServiceException {
    ...
    public <T> Object executeEdit(IObjectData objectData) throws MetadataServiceException {
        objectData.setDescribeId(getObjectDescribeId());
        objectData.setDescribeApiName(apiName);
        objectData.setTenantId(tenantId);
        BaseObjectSaveAction.Arg arg = new BaseObjectSaveAction.Arg();
    ...
    public <T> Object executeDelete(IObjectData objectData) throws MetadataServiceException {
        objectData.setDescribeId(getObjectDescribeId());
        objectData.setDescribeApiName(apiName);
        BaseObjectSaveAction.Arg arg = new BaseObjectSaveAction.Arg();
        arg.setObjectData(ObjectDataDocument.of(objectData));
    ...
    public <T> Object executeInvalid(IObjectData objectData) throws MetadataServiceException {
        objectData.setDescribeId(getObjectDescribeId());
        StandardInvalidAction.Arg arg = new StandardInvalidAction.Arg();
        arg.setObjectDescribeId(getObjectDescribeId());
    ...
    public <T> Object executeBulkInvalid(String json) {
