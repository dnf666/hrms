...
@Slf4j
@Service
public class ObjectDataFieldConvertUtil {
    @Autowired
    private CountryAreaService countryAreaService;
    private static ObjectDataFieldConvertUtil objectDataFieldConvert;
    ...
    public static ObjectDataFieldConvertUtil me() {
        if (objectDataFieldConvert == null) {
            objectDataFieldConvert = SpringUtil.getContext().getBean(ObjectDataFieldConvertUtil.class);
        }
