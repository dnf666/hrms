...
public interface DeliveryNoteProductObjConstants {
    ...
    List<String> READONLY_FIELD_API_NAMES_FOR_NORMAL_EDIT = Lists.newArrayList(
            ...
            Field.ProductId.apiName,
            Field.HasDeliveredNum.apiName,
            Field.DeliveryNum.apiName,
            Field.StockId.apiName,
            Field.ReceiveRemark.apiName,
            Field.RealReceiveNum.apiName,
            Field.DeliveryMoney.apiName
    );
}
