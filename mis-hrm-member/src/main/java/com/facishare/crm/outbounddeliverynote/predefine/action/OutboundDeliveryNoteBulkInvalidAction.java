...
public class OutboundDeliveryNoteBulkInvalidAction extends StandardBulkInvalidAction {
    ...
    protected Result after(Arg arg, Result result) {
        ...
        log.info("OutboundDeliveryNoteBulkInvalidAction.after, arg[{}], actionContext[{}], result[{}], successObjDataList[{}]", arg, actionContext, result, bulkOpResult.getSuccessObjectDataList());
