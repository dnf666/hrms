...
import com.facishare.crm.sfa.predefine.service.CasesInsertImportServiceImpl;
 ...
 */
public class CasesInsertImportDataAction extends StandardInsertImportDataAction {
    private CasesImportService casesImportService = SpringUtil
            .getContext().getBean("casesInsertImportService", CasesInsertImportServiceImpl.class);
